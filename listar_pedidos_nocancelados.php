        ...
        <div class="flex-grid no-responsive-future" style="height: 100%;">
            <div class="row" style="height: 100%">
                ...
                <div class="cell auto-size padding20 bg-white" id="cell-content">
                    <h1 class="text-light">Listar Pedidos que no fueron cancelados:<span class="mif-search place-right"></span></h1>
...
<?php
	...
	conectar_bd();
		...
		{
			echo '<tr><td >No hay registro de pedidos pedidos que falta cancelar</td></tr>';
		}
