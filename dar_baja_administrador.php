...
<h1 class="text-light">Modificar Estado De Los Administradores<span class="mif-users place-right"></span></h1>
...
';
	...
	for ( $i=0; $i< cuantos_registros_bd($usuario_consulta); $i++)
	{
		...
		echo "
    			...
    			<td class='campotablas'><a href=dar_baja_administrador2.php?id=".$registro['cod_usuario']."&estado=Activo >Dar de Baja </a></td>	
				<td class='campotablas'><a href=dar_baja_administrador2.php?id=".$registro['cod_usuario']."&estado=Inactivo>Dar de Alta</a></td>	";
...
<p align="center"><a href="administrar_administradores.php">VOLVER ATRAS</a></p>
