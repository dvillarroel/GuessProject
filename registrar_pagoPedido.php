        ...
        <div class="flex-grid no-responsive-future" style="height: 100%;">
            <div class="row" style="height: 100%">
                ...
                <div class="cell auto-size padding20 bg-white" id="cell-content">
                    <h1 class="text-light">Registrar Pago Pedido:<span class="mif-search place-right"></span></h1>
                    <hr class="thin bg-grayLighter">
						<table class="dataTable border bordered" data-role="datatable" data-auto-width="false" >
							...
							<tr>
								...
								<td class="sortable-column">Registrar pago</td>
...
<?php
	...
	conectar_bd();
		...
		$today = date('Y-m-d');					  
		//echo "SELECT id_venta, codigo_cliente,  fecha_venta, total, estado_venta, estado_pagado, monto_saldo FROM venta WHERE estado_pagado='No Cancelado'";
		$usuario_consulta = mysql_query("SELECT id_venta, codigo_cliente,  fecha_venta, total, estado_venta, estado_pagado, monto_saldo FROM venta WHERE estado_pagado='No Cancelado'");
			...
			for ( $i=0; $i< cuantos_registros_bd($usuario_consulta); $i++)
				{
					...
					echo "
						...
						echo "<td class='campotablas'><a href=registrar_pago.php?id_pedido=".$cod_pedido."&id_cliente=".$codigo_cliente.">Registrar Pago</a></td>
						";
		...
		{
			echo '<tr><td >No hay registro de pedidos para realizar pagos</td></tr>';
		}
