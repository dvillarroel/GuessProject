        ...
        <div class="flex-grid no-responsive-future" style="height: 100%;">
            <div class="row" style="height: 100%">
                ...
                <div class="cell auto-size padding20 bg-white" id="cell-content">
                    <h1 class="text-light">Lista de Pedidos que el cliente debe:<span class="mif-search place-right"></span></h1>
...
<?php
	...
	//$codigo_cliente=$_GET['id_cliente'];
		...
		//echo "SELECT id_venta, codigo_cliente,  fecha_venta, total, estado_venta, estado_pagado, monto_saldo FROM venta WHERE estado_pagado='No Cancelado' and codigo_cliente=".$_GET['id_cliente'];
		$usuario_consulta = mysql_query("SELECT id_venta, codigo_cliente,  fecha_venta, total, estado_venta, estado_pagado, monto_saldo FROM venta WHERE estado_pagado='No Cancelado' and codigo_cliente=".$_GET['id_cliente']);
