...
<form action="modificar_zona3.php" method="post" name="ventas" onSubmit="return validarFormulario();">
...
$resultado= consulta_bd("SELECT id, nombre_zona FROM zona where id=$id" );
$a=sacar_registro_bd($resultado);
$nombre_zona=$a['nombre_zona'];
...
<table width="60%" align="center">
          <tr> 
			...
			echo ' <input type="text" name="codigo_cliente" maxlength="15" readonly="true" tabindex="1" class="Formulario" value='.$id.'>'; ?>            </td>
              <td class="campotablas">Nombre de Zona:</td>
            <td class="campotablas"><input type="text" id="ciField" name="ci" maxlength="30" tabindex="2" class="Formulario" value='<?php echo $nombre_zona;?>' autofocus>            </td>
          </tr>
...
<table width="30%" border="0" align="center" >
    <tr>
      ...
      <form action="modificar_zona.php" method="post"><td align="center"><input name="cancelar"  type="image" onMouseOver= src="images/c2.gif" onMouseMove= src="images/c2.gif" onMouseOut=src="images/c1.gif" value="" SRC="images/c1.gif"> </td> </form>
    </tr>
  </table>
  

<p align="center"><a href="modificar_zona.php">VOLVER ATRAS</a></p>
