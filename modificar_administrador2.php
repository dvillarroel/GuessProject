...
<table width="40%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<td class="panel-titulo3" width="100%" align="center"><font class="titulo_formulario">FORMULARIO 
      DE ACTUALIZACION ADMINISTRADOR</font></td>
    <td class="panel-titulo"><img src="../images/blank.gif" alt="" style="display: block;" height="18" width="16"></td>
  </tr>
</table>
<form action="modificar_administrador3.php?id_persona=<?php echo $codigo_persona;?>&id_user=<?php echo $codigo_usuario;?>" method="post" name="ventas" onSubmit="return validarFormulario(this);">
