        ...
        <div class="flex-grid no-responsive-future" style="height: 100%;">
            <div class="row" style="height: 100%">
                ...
                <div class="cell auto-size padding20 bg-white" id="cell-content">
                    <h1 class="text-light">Detalles registro DUI: <?php echo "<font color='red'>".$_GET['id']."</font>"; ?><span class="mif-search place-right"></span></h1>
...
$usuario_consulta = mysql_query("SELECT id, duinumber, fecha, cod_producto, cantidad, precio FROM dui
WHERE duinumber=".$_GET['id']);
...
';
    ...
    <td class="title" width="10%">Precio</td>
    <td class="title" width="20%">Cantidad</td>
...
';
	for ( $i=0; $i< cuantos_registros_bd($usuario_consulta); $i++)
	{
		...
		echo "
				...
				<td class='campotablas'>".$registro['cod_producto']."</td>
				<td class='campotablas'><font color='green'>".$registro['precio']." Bs.</font></td>
				<td class='campotablas'>".$registro['cantidad']." Unidades</td>";
...
<p align="center"><a href="ver_dui_report.php">VOLVER ATRAS</a></p>
