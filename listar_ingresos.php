        ...
        <div class="flex-grid no-responsive-future" style="height: 100%;">
            <div class="row" style="height: 100%">
                ...
                <div class="cell auto-size padding20 bg-white" id="cell-content">
                    <h1 class="text-light">Ingresos - Seleccionar Periodo:<span class="mif-calculator place-right"></span></h1>
                    <hr class="thin bg-grayLighter">
					<form method="post" action="listarIngresosPagos.php" name="ventas" >
						<select name="select">
						...
						<div class="form-actions">
							<button type="submit" class="button primary">Buscar Ingresos</button>
						</div>
					</form>
                    <hr class="thin bg-grayLighter">
				</div>
