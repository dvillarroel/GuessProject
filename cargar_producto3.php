        ...
        <div class="flex-grid no-responsive-future" style="height: 100%;">
            <div class="row" style="height: 100%">
                ...
                <div class="cell auto-size padding20 bg-white" id="cell-content">
                    <h1 class="text-light">Registro de Productos<span class="mif-apps place-right"></span></h1>
...
foreach ($objPHPExcel->getWorksheetIterator() as $worksheet) {
	...
	//echo $consulta;
			...
			{	
				...
				echo "<td class='campotablas'>El producto con codigo: ".$codigo_producto. "  fue resgistrado en la base de datos</td>
				<td><font color='green'>El producto fue registrado</font></td></tr>";
		
			}
			else
			{
					echo "<td class='campotablas'>El producto: ".$codigo_producto."  ya existe en la base de datos, este no fue registrado</td>
				<td><font color='red'>El producto no fue registrado</font></td></tr>";
