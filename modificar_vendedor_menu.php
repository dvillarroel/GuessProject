        ...
        <div class="flex-grid no-responsive-future" style="height: 100%;">
            <div class="row" style="height: 100%">
                ...
                <div class="cell auto-size padding20 bg-white" id="cell-content">
                    <h1 class="text-light">Modificar Informacion Vendedor<span class="mif-users place-right"></span></h1>
...
';
	...
	for ( $i=0; $i< cuantos_registros_bd($usuario_consulta); $i++)
	{
		...
		echo "
    			...
    			<td class='campotablas'><a href=modificar_vendedor2.php?id=".$registro['cod_persona']."&estado=Activo >Modificar</a></td>";
